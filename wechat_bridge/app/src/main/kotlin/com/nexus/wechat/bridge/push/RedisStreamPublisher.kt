...
/**
 * Async XADD into a Redis Stream. Connection is recreated when config changes.
 *
 * Pool JMX is disabled: Android has no `java.lang.management.ManagementFactory`.
 */
class RedisStreamPublisher(
    private val configProvider: () -> BridgeConfig,
) {
    private val executor = Executors.newSingleThreadExecutor { r ->
        Thread(r, "wechat-redis-xadd").apply { isDaemon = true }
    }
    ...
    private fun ensurePool(cfg: BridgeConfig): JedisPooled {
        ...
        // commons-pool2 registers JMX by default; that class is missing on Android.
    ...
    companion object {
        private const val TAG = "WeChatBridgeRedis"
    }
}
