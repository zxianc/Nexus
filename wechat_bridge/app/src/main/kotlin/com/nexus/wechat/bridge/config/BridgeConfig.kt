 ...
 * Messages → Redis Stream; exceptions → Webhook. No disk event journal.
 */
data class BridgeConfig(
    ...
    /** When true, HTTP APIs (except `/v1/health`) require [apiToken]. */
    ...
    companion object {
        ...
        const val DEFAULT_STREAM_KEY = "nexus:wechat:events"
    }
}
